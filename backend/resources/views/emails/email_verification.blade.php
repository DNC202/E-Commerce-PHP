<x-mail::message>
    ...
    Cảm ơn quý khách đã sử dụng dịch vụ của chúng tôi! Để hoàn tất quá trình đăng ký và kích hoạt tài khoản của quý
    khách, vui lòng xác thực địa chỉ email bằng cách nhấp vào nút bên dưới

    <x-mail::button :url="'http://localhost:5173/active/'.$token">
        Xác thực tài khoản
    </x-mail::button>
